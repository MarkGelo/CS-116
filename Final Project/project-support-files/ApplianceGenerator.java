...
*/
		try
		{
			...
			for (long location=1;location<=(Integer.parseInt(args[0])/10) ;location++ ) {   //appliances the user wanted divided by 10 to get number of locations
				int applianceCount=(int)(Math.random()*4)+8;  //8-12 appliances per location 
